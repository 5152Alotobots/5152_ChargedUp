  ...
  public static final class Field {
    ...
    public static final class Balls {
      ...
      public static final Translation2d kB2 =
          new Translation2d(Units.inchesToMeters(199), Units.inchesToMeters(174));
    }
    ...
    public static final class StartingPos {
      ...
      public static final Pose2d kT13_Start =
          new Pose2d(
              new Translation2d(Units.inchesToMeters(241), Units.inchesToMeters(108)),
