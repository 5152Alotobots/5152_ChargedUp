...
public class CmdGrp_TestVisionAuto extends SequentialCommandGroup {
  ...
  public CmdGrp_TestVisionAuto(
    ...
    addCommands(
        ...
        new Cmd_NavigateToBestVisionTarget(driveSubSys, photonvision, bling, Const_Photonvision.Cameras.frontCamera, Const_Photonvision.Pipelines.Apriltag, false, true, false).withTimeout(5),
