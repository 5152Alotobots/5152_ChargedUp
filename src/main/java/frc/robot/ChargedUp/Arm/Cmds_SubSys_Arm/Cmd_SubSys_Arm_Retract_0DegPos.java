...
public class Cmd_SubSys_Arm_Retract_0DegPos extends SequentialCommandGroup {
  private final SubSys_Arm subsysArm;

  /** Creates a new Cmd_HighConePlacement. */
  public Cmd_SubSys_Arm_Retract_0DegPos(SubSys_Arm subSys_Arm) {
    ...
    addCommands(
      ...
      new Cmd_SubSys_Arm_PosCmd(subsysArm, 0.0, true, 0.85, true)
