...
public class Cmd_GetDistanceToTarget extends CommandBase {
  ...
  /**
   * Constructs a new {@link Cmd_GetDistanceToTarget} command with the specified PhotonVision camera, pipeline index, 
   * and hand subsystem.
   *
  ...
  public void execute() {
    ...
    if (result.hasTargets()){
      SmartDashboard.putNumber("dist", subSys_Photonvision.getRangeToTarget(result, pipelineIndex));
