...
public class Cmd_NavigateToBestVisionTargetAndPickup extends CommandBase {  
  //Declare Variables 
   ...
   * @param Joystick_DS 
   */
  public Cmd_NavigateToBestVisionTargetAndPickup( SubSys_DriveTrain subSys_DriveTrain, SubSys_Photonvision subSys_Photonvision, SubSys_Hand subSys_Hand) {
    ...
    addRequirements(subSys_DriveTrain, subSys_Photonvision, subSys_Hand);
  }
  ...
  public void execute() {
    ...
    if (subSys_Photonvision.isAtTarget(resultFront)) {
