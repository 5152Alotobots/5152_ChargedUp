 ...
 */
public class Auto_allianceblue_Cmd extends SequentialCommandGroup {
  private final SubSys_DriveTrain m_DriveTrain;
  private final SubSys_PigeonGyro m_pigeonGyro;
  private final SubSys_Hand m_hand;
  /** Creates a new Auto_Challenge1_Cmd. */
  public Auto_allianceblue_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Hand handSubSys) {
    ...
    addCommands(
        ...
        new InstantCommand(m_hand::OpenHand, m_hand),
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "allianceblue", true, true));
  }
}
