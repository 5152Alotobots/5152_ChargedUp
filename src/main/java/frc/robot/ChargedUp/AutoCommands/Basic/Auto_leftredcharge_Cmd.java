...
public class Auto_leftredcharge_Cmd extends SequentialCommandGroup {
  ...
  public Auto_leftredcharge_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Bling subSys_Bling) {
    ...
    addCommands(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "leftredcharge", true, true, Alliance.Red, PoseEstimationStrategy.OdometryONLY),
