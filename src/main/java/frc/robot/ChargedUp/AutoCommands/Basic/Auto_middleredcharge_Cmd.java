...
/**
 * *Link For PathPlaner *
 * https://docs.google.com/presentation/d/1xjYSI4KpbmGBUY-ZMf1nAFrXIoJo1tl-HHNl8LLqa1I/edit#slide=id.g1e65ac68f1d_0_43
 */
public class Auto_middleredcharge_Cmd extends SequentialCommandGroup {
  ...
  public Auto_middleredcharge_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Bling subSys_Bling) {
    ...
    addCommands(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "middleredcharge", true, true, Alliance.Red, PoseEstimationStrategy.OdometryONLY),
