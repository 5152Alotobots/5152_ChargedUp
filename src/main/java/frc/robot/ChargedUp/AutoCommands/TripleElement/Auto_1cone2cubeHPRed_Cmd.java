...
public class Auto_1cone2cubeHPRed_Cmd extends SequentialCommandGroup {
  ...
  */
  public Auto_1cone2cubeHPRed_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Hand handSubSys, SubSys_Arm armSubSys, SubSys_Photonvision photonvisionSubSys, SubSys_Bling blingSubSys) {
    ...
    ParallelCommandGroup armRotateAndExtendDriveToDeliverCube2MidLevelParallel = new ParallelCommandGroup(
      armRotateAndExtendToMidLevelCubeFromPickupSequential.withTimeout(5), // Lift arm to pickup pos
