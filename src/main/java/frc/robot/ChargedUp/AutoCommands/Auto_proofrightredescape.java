...
public class Auto_proofrightredescape extends SequentialCommandGroup {
  ...
  public Auto_proofrightredescape(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Bling subSys_Bling) {
    ...
    addCommands(
        ...
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "proofrightredescape", true, true),
