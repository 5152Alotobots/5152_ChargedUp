 ...
 */
public class Auto_proofrightredescape extends SequentialCommandGroup {
  private final SubSys_DriveTrain m_DriveTrain;
  private final SubSys_PigeonGyro m_pigeonGyro;

  /** Creates a new Auto_Challenge1_Cmd. */
  public Auto_proofrightredescape(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro) {
    ...
    addCommands(
        ...
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "proofrightredescape", true, true),
