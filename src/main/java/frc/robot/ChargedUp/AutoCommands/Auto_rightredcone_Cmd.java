  ...
  public Auto_rightredcone_Cmd(
    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "rightbluecone1", true, true, Alliance.Red)),
        new InstantCommand(subsysHand::OpenHand, subsysHand),
        new ParallelCommandGroup(
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "rightbluecone2", false, false, Alliance.Red),
