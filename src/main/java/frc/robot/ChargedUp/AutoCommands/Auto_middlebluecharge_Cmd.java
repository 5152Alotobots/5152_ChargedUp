...
public class Auto_middlebluecharge_Cmd extends SequentialCommandGroup {
  ...
  public Auto_middlebluecharge_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro) {
    m_DriveTrain = driveSubSys;
    m_pigeonGyro = pigeonGyro;
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "middlebluecharge", true, true, Alliance.Blue));
