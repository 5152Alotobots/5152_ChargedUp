...
public class Auto_worlds_vision_blue_Cmd extends SequentialCommandGroup {
  ...
  public Auto_worlds_vision_blue_Cmd(
    ...
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new Cmd_RevHighConePlacement(subsysArm, subsysHand),
