...
public class Auto_leftbluecharge_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_leftbluecharge_1cone_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Arm arm, SubSys_Hand hand) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "leftcharge_1cone", true, true, Alliance.Blue),
