 ...
 */
public class Auto_Stateplacepickupcharge_blue_Cmd extends SequentialCommandGroup {
    ...
    public Auto_Stateplacepickupcharge_blue_Cmd(
    ...
    ParallelCommandGroup driveAndRetractArm =
                new ParallelCommandGroup(
                    new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                        driveSubSys, "complex3", true, true, Alliance.Blue),
