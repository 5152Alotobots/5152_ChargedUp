...
public class Auto_leftblueescape_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_leftblueescape_1cone_Cmd(SubSys_DriveTrain driveSubSys, SubSys_Arm arm, SubSys_Hand hand, SubSys_PigeonGyro pigeonGyro, SubSys_Bling bling) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "leftescape_1cone", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
