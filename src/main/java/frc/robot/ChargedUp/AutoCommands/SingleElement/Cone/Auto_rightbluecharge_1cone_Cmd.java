 ...
 */
public class Auto_rightbluecharge_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_rightbluecharge_1cone_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Arm arm, SubSys_Hand hand, SubSys_Bling bling) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "rightcharge_1cone", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
    ...
    addCommands(
        ...
        new Cmd_AutoBalance(pigeonGyro, driveSubSys, bling), // Balance on charge station
