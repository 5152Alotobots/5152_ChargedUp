...
public class Auto_Lakeview_1cube_Cmd extends SequentialCommandGroup {
  ...
  public Auto_Lakeview_1cube_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Arm arm, SubSys_Hand hand, SubSys_Bling bling) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "lakeview", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
