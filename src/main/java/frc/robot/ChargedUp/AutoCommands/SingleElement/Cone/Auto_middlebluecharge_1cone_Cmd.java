 ...
 */
public class Auto_middlebluecharge_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_middlebluecharge_1cone_Cmd(
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "middlecharge_1cone", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
