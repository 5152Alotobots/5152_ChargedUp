...
public class Auto_rightblueescape_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_rightblueescape_1cone_Cmd(
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "rightescape_1cone", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
