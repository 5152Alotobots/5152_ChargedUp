...
public class Auto_leftblueescape_1cube_Cmd extends SequentialCommandGroup {
  ...
  public Auto_leftblueescape_1cube_Cmd(SubSys_DriveTrain driveSubSys, SubSys_Arm arm, SubSys_Hand hand, SubSys_PigeonGyro pigeonGyro, SubSys_Bling bling) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "leftescape_1cube", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
