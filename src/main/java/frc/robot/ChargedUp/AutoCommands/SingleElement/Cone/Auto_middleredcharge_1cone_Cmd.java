...
public class Auto_middleredcharge_1cone_Cmd extends SequentialCommandGroup {
  ...
  public Auto_middleredcharge_1cone_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Arm arm, SubSys_Hand hand, SubSys_Bling bling) {
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "middlecharge_1cone", true, true, Alliance.Red, PoseEstimationStrategy.OdometryONLY),
