 ...
 */
public class Auto_leftbluecharge_1cube_Cmd extends SequentialCommandGroup {
  ...
  public Auto_leftbluecharge_1cube_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro, SubSys_Arm arm, SubSys_Hand hand, SubSys_Bling blingSubSys) {
    m_DriveTrain = driveSubSys;
    m_pigeonGyro = pigeonGyro;
    subsysArm = arm;
    subsysHand = hand;
    subsysBling = blingSubSys;
    ...
    ParallelCommandGroup driveAndRetractArm = new ParallelCommandGroup(
        new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
            driveSubSys, "leftcharge_1cube", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
    ...
    addCommands(
        ...
        new Cmd_AutoBalance(pigeonGyro, driveSubSys, blingSubSys), // Balance on charge station
