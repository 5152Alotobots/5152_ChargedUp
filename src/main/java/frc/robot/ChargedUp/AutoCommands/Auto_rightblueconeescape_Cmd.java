...
/** *Link For PathPlaner * */
public class Auto_rightblueconeescape_Cmd extends SequentialCommandGroup {
  ...
  public Auto_rightblueconeescape_Cmd(
    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "rightblueconeescape", true, true, Alliance.Blue)),
