...
/** *Link For PathPlaner * */
public class Auto_leftbluecone_Cmd extends SequentialCommandGroup {
    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "leftbluecone1", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY)),
        new InstantCommand(subsysHand::OpenHand, subsysHand),
        new ParallelCommandGroup(
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "leftbluecone2", false, false, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
