    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "leftbluecone1", true, true, Alliance.Red, PoseEstimationStrategy.OdometryONLY)),
        new InstantCommand(subsysHand::OpenHand, subsysHand),
        new ParallelCommandGroup(
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "leftbluecone2", false, false, Alliance.Red, PoseEstimationStrategy.OdometryONLY),
