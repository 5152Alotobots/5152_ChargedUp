    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "rightbluecone1", true, true, Alliance.Blue, PoseEstimationStrategy.OdometryONLY)),
        new InstantCommand(subsysHand::OpenHand, subsysHand),
        new ParallelCommandGroup(
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
                driveSubSys, "rightbluecone2", false, false, Alliance.Blue, PoseEstimationStrategy.OdometryONLY),
