...
public class Auto_OneConeRed_Cmd extends SequentialCommandGroup {
  private final SubSys_DriveTrain m_DriveTrain;
  private final SubSys_PigeonGyro m_pigeonGyro;

  /** Creates a new Auto_Challenge1_Cmd. */
  public Auto_OneConeRed_Cmd(SubSys_DriveTrain driveSubSys, SubSys_PigeonGyro pigeonGyro) {
    ...
    //new Cmd_whatever the arm one is
      new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(driveSubSys, "OneConeRed", true, true),
