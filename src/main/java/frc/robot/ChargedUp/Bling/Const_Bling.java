...
public class Const_Bling {

    public static final class Controllers {
        public static final Spark controller1 = new Spark(0);
    }
    ...
    public static final class Patterns {
        ...
        public static final class FixedPalette {
            ...
            public static final double RainbowLava = -0.93;
            ...
            public static final double BpmRainbow = -0.69;
            public static final double BpmParty = -0.67;
            public static final double BpmOcean = -0.65;
            public static final double BpmLava = -0.63;
            public static final double BpmForest = -0.61;
            public static final double FireMedium = -0.59;
            public static final double FireLarge = -0.57;
            public static final double TwinkleRainbow = -0.55;
            public static final double TwinkleParty = -0.53;
            public static final double TwinkleOcean = -0.51;
            public static final double TwinkleLava = -0.49;
            public static final double TwinkleForest = -0.47;
            ...
            public static final double LightChaseRed = -0.31;
            public static final double LightChaseBlue = -0.29;
            public static final double LightChaseGray = -0.27;
        ...
        public static final class Color2 {
            ...
            public static final double HeartbeatSlow = 0.23;
            public static final double HeartbeatMedium = 0.25;
            public static final double HeartbeatFast = 0.27;
            public static final double BreathSlow = 0.29;
            public static final double BreathFast = 0.31;
            public static final double Shot = 0.33;
            public static final double Strobe = 0.35;
        }

        public static final class Color1Color2 {
            public static final double SparkleC1OnC2 = 0.37;
            public static final double SparkleC2OnC1 = 0.39;
            public static final double ColorGradient = 0.41;
            public static final double BeatsPerMinute = 0.43;
            public static final double EndToEndBlend = 0.45;
            public static final double EndToEndBlendReverse = 0.47;
            public static final double NoBlend = 0.49;
            public static final double Twinkles = 0.51;
            public static final double ColorWaves = 0.53;
