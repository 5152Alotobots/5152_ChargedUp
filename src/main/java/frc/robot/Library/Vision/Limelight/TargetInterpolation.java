...
public class TargetInterpolation {
  ...
  public void calcInterpIndexAndFrac(double distance) {
    ...
    */
    if (distance < RobotSettings.Shooting.kShootDistance[0]) {
      ...
      m_Index = 0;
      m_Frac =
          (distance - RobotSettings.Shooting.kShootDistance[m_Index])
              / (RobotSettings.Shooting.kShootDistance[m_Index + 1]
                  - RobotSettings.Shooting.kShootDistance[m_Index]);
  ...
  public double calcArmAngle() {
    ...
    if (m_Index >= RobotSettings.Shooting.kShootDistance.length - 1) {
      armAngle =
          RobotSettings.Shooting.kShootingAngle[RobotSettings.Shooting.kShootDistance.length - 1];
    } else {
      armAngle =
          RobotSettings.Shooting.kShootingAngle[m_Index]
              + m_Frac
                  * (RobotSettings.Shooting.kShootingAngle[m_Index + 1]
                      - RobotSettings.Shooting.kShootingAngle[m_Index]);
    }
    return armAngle;
  }
  ...
  public double calcInNOutVel() {
    ...
    if (m_Index >= RobotSettings.Shooting.kShootDistance.length - 1) {
      inNOutVel =
          RobotSettings.Shooting.kShootingInNOutVel[
              RobotSettings.Shooting.kShootDistance.length - 1];
    } else {
      inNOutVel =
          RobotSettings.Shooting.kShootingInNOutVel[m_Index]
              + m_Frac
                  * (RobotSettings.Shooting.kShootingInNOutVel[m_Index + 1]
                      - RobotSettings.Shooting.kShootingInNOutVel[m_Index]);
    }
    return inNOutVel;
  }
  ...
  public double calcInNOutLwrVel() {
    ...
    if (m_Index >= RobotSettings.Shooting.kShootDistance.length - 1) {
      inNOutLwrVel =
          RobotSettings.Shooting.kShootingInNOutLwrVel[
              RobotSettings.Shooting.kShootDistance.length - 1];
    } else {
      inNOutLwrVel =
          RobotSettings.Shooting.kShootingInNOutLwrVel[m_Index]
              + m_Frac
                  * (RobotSettings.Shooting.kShootingInNOutLwrVel[m_Index + 1]
                      - RobotSettings.Shooting.kShootingInNOutLwrVel[m_Index]);
    }
    return inNOutLwrVel;
  }
